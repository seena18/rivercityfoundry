...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 bg-paper border-b border-rule z-50 font-sans">
        ...
        <div className="relative flex justify-between h-24 items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="text-lg font-bold tracking-tight text-soot uppercase leading-none">
                River City Foundry<br/><span className="text-[10px] tracking-[0.2em] text-[#8C6A1F] font-normal">Web & Software Studio</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-8">
              {[
                ...
                { name: 'Contact', href: '/contact' }
                  ...
                  <Link key={item.name} href={item.href} className="text-soot text-xs font-bold uppercase tracking-widest hover:text-[#8C6A1F] transition-colors relative group">
                      {item.name}
                      <span className="absolute -bottom-2 left-0 w-0 h-[1px] bg-[#8C6A1F] transition-all group-hover:w-full"></span>
                  </Link>
              ))}
          </nav>
          ...
          <div className="hidden md:flex items-center gap-6">
                <a href="tel:9165420331" className="text-xs font-bold text-soot hover:text-[#8C6A1F] transition-colors hidden lg:block uppercase tracking-widest" aria-label="Call 916.542.0331">
                    Call 916.542.0331
                </a>
          ...
          <div className="md:hidden">
            <button 
              ...
              className="text-soot hover:text-[#8C6A1F] focus:outline-none p-2"
